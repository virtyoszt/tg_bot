...
bot = telebot.TeleBot('5057583129:AAEfahR2xaZVAvZJJGEU_UsLlJyvEJHreDo') # Токен бота воркеров

admin = 326061402 # ID Админа
support = 326061402 # ID сапорта
channel_id = -1001612279710 # ID Канала залётов
chat_worker_id = -1001778765304 # ID Чата с воркерами

bot_name = '🎰777🎰 | Workers' # Username Бота

mater = '' # Ссылка на мануалы
zalet = 'https://t.me/casino777_vuplaty' # Ссылка на канал с залётами
