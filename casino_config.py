...
tickets = '5057583129:AAEfahR2xaZVAvZJJGEU_UsLlJyvEJHreDo' # TOKEN Бота воркера
bot = telebot.TeleBot('5065125585:AAGrFI0JvqVS4bhmklxpB8IwD-eWyIoGJTY') # TOKEN Бота казино

admin = 326061402 # ID Админа
support_id = 326061402 # ID Саппорта
channel_id = -1001612279710 # ID Канала с вылатами
support = 'enchanto' # Username Сапорта

phone = '380992500901' # Номер киви без +
token = '921fbc8b43c24160191bfefcc77a08c6' # API TOKEN QIWI
